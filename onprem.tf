...
resource "aws_instance" "ace-onprem-partner-csr" {
  ...
  user_data                   = <<EOF
    ...
    ios-config-1110 = "integrity sha 256"
    ...
    ios-config-1175 = "identity local address ${aws_instance.ace-onprem-dc-csr.public_ip}"
    ...
    ios-config-1220 = "set security-association lifetime seconds 3600"
    ios-config-1225 = "set transform-set OnPrem-Aviatrix"
    ios-config-1230 = "set pfs group14"
    ios-config-1235 = "set ikev2-profile OnPrem-Aviatrix"
    ios-config-1240 = "set security-association lifetime kilobytes disable"
